...
const changeLanguage = (ln) => {
   ...
   if(ln==="ru"){
    if(window.location.href.split('/')[window.location.href.split('/').length-2]==="allnews" || window.location.href.split('/')[window.location.href.split('/').length-2]==="xarita" || "tashkilot"){
