...
<div className='chiz'></div>
                        ...
                        {/* <li className="app_nav-list_item" onClick={closeNavbar}>
                         ...
                         <li className="app_nav-list_item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisActivetassarufidagi(true) }} className={isActivetassarufidagi?"active":''}  to={t("check")?"/filiallar":"/filiallar"}><a className="app_nav-list_link" dangerouslySetInnerHTML={{ __html: t("tassarufidagi_tashkilotlar") }}></a></NavLink>
                                </li>
                                <li className="app_nav-list_item" onClick={closeNavbar}>
