                    ...
                    <ul className="app_nav-list">
                        <li className="app_nav-list_item with_sublist">
                            ...
                            <div className='chiz1'></div>
                                ...
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActiverahbariyat(true) }} className={isActiverahbariyat?"active":''}  to={t("check")?"/rahbariyat":"/rahbariyat"}> <a className="app_nav-sub_list-link">{t('rahbariyat')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivemarkaziy_aparat(true) }} className={isActivemarkaziy_aparat?"active":''}  to={t("check")?"/markaziy-aparat":"/markaziy-aparat" > <a className="app_nav-sub_list-link">{t('markaziy_aparat')}</a></NavLink>
                                </li>
