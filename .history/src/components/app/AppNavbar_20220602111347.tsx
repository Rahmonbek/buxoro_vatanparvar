...
<div className='chiz'></div>
                        ...
                        {/* <li className="app_nav-list_item" onClick={closeNavbar}>
                         ...
                         <li className="app_nav-list_item" onClick={closeNavbar}>
                                ...
                                <li className="app_nav-list_item" onClick={closeNavbar}>
                            <NavLink onClick={()=>{setFalse();setisActivexarita(true) }} className={isActivexarita?"active":''}  to={t("check")?"/xarita/0":"/xarita/0"}><a className="app_nav-list_link">{t('xarita')}</a></NavLink>
                        </li>
                                <li className="app_nav-list_item" onClick={closeNavbar}>
