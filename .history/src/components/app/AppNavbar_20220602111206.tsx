                    ...
                    <ul className="app_nav-list">
                        <li className="app_nav-list_item with_sublist">
                            ...
                            <div className='chiz1'></div>
                                ...
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActiverahbariyat(true) }} className={isActiverahbariyat?"active":''}  to={t("check")?"/rahbariyat":"/rahbariyatru"}> <a className="app_nav-sub_list-link">{t('rahbariyat')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
