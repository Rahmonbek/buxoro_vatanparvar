        ...
        <nav className="app_nav">
            ...
            <div className="container">
                <div className="app_nav-info" onClick={()=>{setFalse()}}>
                    <NavLink to={t()"/" className="app_nav-logo">
                        ...
                        <li className="app_nav-list_item with_sublist">
                            ...
                            <div className='chiz1'></div>
                                ...
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivemarkaziy(true) }} className={isActivemarkaziy?"active":''}  to={t()"/markaziy-kengash"><a className="app_nav-sub_list-link" href="../home/Markaziy">{t('markaziy_kengash')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActiverahbariyat(true) }} className={isActiverahbariyat?"active":''}  to={t()"/rahbariyat"> <a className="app_nav-sub_list-link">{t('rahbariyat')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivemarkaziy_aparat(true) }} className={isActivemarkaziy_aparat?"active":''}  to={t()"/markaziy-aparat" > <a className="app_nav-sub_list-link">{t('markaziy_aparat')}</a></NavLink>
                                </li>
                               
                                {/* <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivehududiy(true) }} className={isActivehududiy?"active":''}  to={t()"/hududiy-kengashlar"><a className="app_nav-sub_list-link">{t('hududiy_kengashlar')}</a></NavLink>
                                </li> */}
                                {/* <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivetashkilot(true) }} className={isActivetashkilot?"active":''}  to={t()"/tashkilot-tarixi" > <a className="app_nav-sub_list-link">{t('tashkilot_tarixi')}</a></NavLink>
                                </li> */}
                                {/* <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivexalqaro(true) }} className={isActivexalqaro?"active":''}  to={t()"/xalqaro-hamkorlik">  <a className="app_nav-sub_list-link" dangerouslySetInnerHTML={{ __html: t("xalqaro_hamkorlik") }}></a></NavLink>
                                </li> */}
                            </ul>
                        </li>
                        <li className="app_nav-list_item with_sublist">
...
<div className='chiz'></div>
                                ...
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisaxborot_xizmati(true);setisActivebarcha_yangiliklar(true) }} className={isActivebarcha_yangiliklar?"active":''}  to={t()"/allnews"><a className="app_nav-sub_list-link">{t('barcha_yangiliklar')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisaxborot_xizmati(true);setisActivefotogalereya(true) }} className={isActivefotogalereya?"active":''}  to={t()"/fotogalareya"><a className="app_nav-sub_list-link">{t('fotogalereya')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                        ...
                        {/* <li className="app_nav-list_item" onClick={closeNavbar}>
                            <NavLink onClick={()=>{setFalse();setisActivehujjatlar(true) }} className={isActivehujjatlar?"active":''}  to={t()"/hujjatlar"><a className="app_nav-list_link">{t('hujjatlar')}</a></NavLink>
                        </li> */}
                         <li className="app_nav-list_item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisActivetassarufidagi(true) }} className={isActivetassarufidagi?"active":''}  to={t()"/filiallar"><a className="app_nav-list_link" dangerouslySetInnerHTML={{ __html: t("tassarufidagi_tashkilotlar") }}></a></NavLink>
                                </li>
                                <li className="app_nav-list_item" onClick={closeNavbar}>
                            <NavLink onClick={()=>{setFalse();setisActivexarita(true) }} className={isActivexarita?"active":''}  to={t()"/xarita/0"><a className="app_nav-list_link">{t('xarita')}</a></NavLink>
                        </li>
                                <li className="app_nav-list_item" onClick={closeNavbar}>
                            <NavLink onClick={()=>{setFalse();setisActivekantaktlar(true) }} className={isActivekantaktlar?"active":''}  to={t()"/kontaktlar"><a className="app_nav-list_link">{t('kantaktlar')}</a></NavLink>
                        </li>
...
<div className='chiz'></div>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setismurojat_qilish(true);setisActiveonlayn(true) }} className={isActiveonlayn?"active":''}  to={t()"/onlayn-murojat"><a className="app_nav-sub_list-link">{t('onlayn_murojat')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setismurojat_qilish(true);setisActiveh(true) }} className={isActiveh?"active":''}  to={t()"/haydovchilik-maktabiga-yozilish"><a className="app_nav-sub_list-link">{t('h_maktabga')}</a></NavLink>
                                </li>
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setismurojat_qilish(true);setisActivek(true) }} className={isActivek?"active":''}  to={t()"/kasb-hunar-maktabiga-yozilish"> <a className="app_nav-sub_list-link" dangerouslySetInnerHTML={{ __html: t("k_maktabga") }}></a></NavLink>
                                </li>
                            </ul>
                        </li>
