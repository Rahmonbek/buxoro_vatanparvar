          ...
          <div className="container">
            ...
            >
              ...
              <div
                      ...
                      >
                        <Image className='red' style={{height:'auto', width:"100%" }} src={data!==null?data[0][0].branchImage:''}/>  
                      </div>
                      </SwiperSlide></Swiper>
                     <p>{data!==null && (data[0][0].branchImageDescriptionUz!==null || data[0][0].branchImageDescriptionRu!==null)?data[0][0].branchImageDescriptionUz!==null?data[0][0].branchImageDescriptionUz:data[0][0].branchImageDescriptionRudata[0][0].branchImageDescriptionRu!==null?data[0][0].branchImageDescriptionRu:data[0][0].branchImageDescriptionUz:''}</p>
                  </div>
