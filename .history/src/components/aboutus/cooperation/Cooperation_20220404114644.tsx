          ...
          <div className="container">
            ...
            >
              ...
              <div
                     ...
                     <p>{data!==null?data[0].branchImageDescriptionUz!==null?data[0].branchImageDescriptionUz:data[0].branchImageDescriptionRudata[0].branchImageDescriptionUz!==null?data[0].branchImageDescriptionUz:data[0].branchImageDescriptionRu:''}</p>
                  </div>
