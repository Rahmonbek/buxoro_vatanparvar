              ...
              <Image  className="img" src={user} alt="img" />
               ...
               <div className="rahbariyat-list-text sug">
                 <p  className="rahbariyat-list-text-position" style={{marginTop:"10px"}}>
                   ...
                   dmfmsdvkmsdvmldsfvnkfnl dfndflk ndn fn
                 </b></p>
                 ...
                 <div className="icons" style={{marginTop:'0px'}}>
                   <FaRegCalendarCheck  className="icon"  size="1.5rem" color="#244BA4" cursor="pointer"/>
                    <p  style={{position:'relative', top:'-14px'}}>dsvdvsdvd</p>
                 </div>
                 <div className="icons">
                   <FiPhone className="icon"  size="1.5rem" color="#244BA4" cursor="pointer"/>
                    <p  style={{position:'relative', top:'-14px'}}><a href={`tel: `}>scdssdvdv </a></p>
                 </div>
               
                 <div className="icons">
                   <HiOutlineMail className="icon iconn" size="1.5rem" color="#244BA4" cursor="pointer"/>
                    <p  style={{position:'relative', top:'-14px'}}><a href={`mailto: dsvsvdv`}>scsdvsdv</a></p>
                 </div>
