        ...
        .then(function(result) {
          ...
          function paint(iso) {
            ...
            if(regionG.id==="UZ"){
                ...
                regionG.options.fillColor = "#f330";
                regionG.options.strokeColor = "#6c7e9d";
                regionG.options.strokeOpacity = "1";
                regionG.options.strokeWidth = "3";
                
            }else{
                regionG.options.fillColor = "#f9f6f0";
                regionG.options.strokeOpacity = "0";
                regionG.options.strokeWidth = "5";
            }
...
window.location.href=linkR.slice(0, linkR.lastIndexOf("/"))+"/"+a
  ...
  :''}
        ...
        <option value={0}>{t("check")?"Barcha tashkilotlar":"Все организации"}</option>
          {dataRegion!==null?dataRegionG.map((item, key)=>{
              ...
              {data.length!==0 && data[0].length!==0?data[0].map((info, index) => {
                  ...
                  return (
                    ...
                    onClick={()=>{var a=info;a.type='region';openModalRegion(a)}}
                       ...
                       options={{
                         preset:info.regionId===regionG?"islands#redDotIcon":"islands#nightDotIcon",
