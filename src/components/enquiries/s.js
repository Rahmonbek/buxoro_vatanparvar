...
<Form.Item data-placeholder="Viloyat" label=" " className= {regionsClass?"forPlace":''} tooltip={{ title: "E'tiborli bo'ling" , icon: <InfoCircleOutlined /> }} name="regionId"  rules={[{ required: true }]}>
<Select
  className="border"
  placeholder={!regionsClass?"Viloyat":''}
  onChange={(value) => {setRegionsClass(true);setDistrictL(value);setDistrictL(true);setDistrictdata(null);handleDistrict(value)}}
...
>
 {regions!==null?regions.map((item:any)=>{
    ...
    <Form.Item data-placeholder="Tuman"  className= {districtClass?"forPlace":''} label=" "  tooltip={{ title: "E'tiborli bo'ling" , icon: <InfoCircleOutlined /> }} name="districtId"  rules={[{ required: true }]}>
<Select
value={districtdata}
  className="border"
  placeholder={!districtClass?"Tuman":''}
  onChange={(value) => {setSchoolL(value);setSchoolL(true);setDistrictClass(true);setDistrictdata(value);handleSchool(value)}}
  disabled={districtS} 
  loading={districtL}
  
>
  
  {district!==null?district.map((item:any)=>{
     return(<Option value={item.id}>{item.nameUz}</Option>)
 }):""} 
</Select>
...
{districtdata===null?<></>:''}
    ...
    <Form.Item  label=" " data-placeholder="Avtomaktab nomi"  className= {schoolClass?"forPlace":''} tooltip={{ title: "E'tiborli bo'ling" , icon: <InfoCircleOutlined /> }} name="branchId"  rules={[{ required: true }]}>
<Select
value={schooldata}
  className="border"
  placeholder={!schoolClass?"Avtomaktab nomi":''}
  
  onChange={(value) => {setSchooldata(value);setSchoolClass(true);setBranchL(value);setBranchL(true);handleCategory(value)}}
  disabled={schoolS} 
  loading={schoolL}
...
{schooldata===null?<></>:''}
    ...
    <Form.Item  label=" " data-placeholder="Toifa turi"  className= {categoryClass?"forPlace":''} tooltip={{ title: "E'tiborli bo'ling" , icon: <InfoCircleOutlined /> }} name="categoryId"  rules={[{ required: true }]}>
<Select
value={branchdata}
  className="border"
  placeholder={!schoolClass?"Toifa turi":''}
  disabled={branchS} 
  loading={branchL}
  onChange={(value) => {setBranchdata(value);setSchoolClass(true);}}
...
{branchdata===null?<></>:''}
    ...
    <Form.Item  label=" "  tooltip={{ title: "E'tiborli bo'ling" , icon: <InfoCircleOutlined /> }} name="shiftId"  rules={[{ required: true }]}>
<Select
  className="border"
  placeholder="Ta'lim vaqti"
